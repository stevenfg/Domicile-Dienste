        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <h4 class="nav-link" style="font-size: medium; padding-top:15px; color:#4592B6;text-transform: capitalize;">WELCOME, <?php if(empty($_SESSION['user'])){ echo "Noobie";} else { echo $_SESSION['user']; }?></h4> 
            ...
            <div class="booking_table d_flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
                        ...
                        <?php  if(!empty($_SESSION['user'])){ ?>
                        <a href="services.html" class="btn theme_btn button_hover">Book Now</a>
                        <?php 
                            }
                            else{
                        ?>
                ...
                <div class="row mb_30">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4">Salon</h4></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4">Carpentry</h4></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4">Cleaning </h4></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <a href="#"><h4 class="sec_h4">Electrician</h4></a>

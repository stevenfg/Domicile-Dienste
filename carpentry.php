    ...
    <?php
            ...
            <div class="row" style="background-color: #110549;border-radius: 20px;">
                ...
                <div class="col-md-4 col-lg-10 ml-auto align-items-center mt-md-0" style="padding-bottom: 20px; "> <!--add d-flex to align vertically center -->
                    ...
                    <div class="row"><h3 style="color: #8AB9FF; padding-top:5px; padding-right:20px;">⭐4.5/5</h3><a href="admin/booking.php?rn=<?php echo $row['name'] . "&rt=b";?>" class="btn theme_btn_small button_hover <?php if($row["status"]==0){echo "active";}else{echo "disabled";}?>" role="button" aria-disabled="<?php if($row['status']==0){echo "false";}else{echo "true";}?>" style=" padding-top:7px; padding-right:30px;" >Book Now</a></div>
